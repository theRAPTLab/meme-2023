 ...
 */
ADMObj.Model = data => {
  if (data.unitId === undefined) throw Error('Model requires a unitId!');
...
ADMObj.SentenceStarter = data => {
  if (data.classroomId === undefined)
    throw Error('SentenceStarter requires a classroomId!');
  return {
    id: data.id,
    classroomId: data.classroomId,
...
ADMObj.RatingsDefinition = data => {
  if (data.classroomId === undefined)
    throw Error('RatingsDefinition requires a classroomId!');
  return {
    id: data.id,
    classroomId: data.classroomId,
