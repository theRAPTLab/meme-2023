module.exports = {
  ...
  entities: [
    ...
    // mechs
    {
      ...
      target: 11,
      name: 'increase',
      description: 'An increase is good'
    },
    { id: 21, type: 'mech', source: 11, target: 12, name: 'increase' },
    {
      ...
      target: 13,
      name: 'die (increase)',
      description: 'Fish die with an increase'
    },
    ...
    },
    {
      ...
      numberLabel: '2f',
      rating: 1,
      note: 'ammonia is bad3'
    }
  ],
  // visuals do not share ids
  visuals: [{ id: 10, type: 'vprop', pos: { x: 0, y: 0 }, state: {} }],
