...
PMCView.DefineDefs = svg => {
  ...
  SVGDEFS.set(
    ...
    (() => {
      ...
      icon
        .path('M8 11.5C9.65685 11.5 11 10.1046 11 9H5C5 10.1046 6.34315 11.5 8 11.5Z')
        .fill(`#0BAC8F`);
      icon
        .path('M8 13.6C11.0928 13.6 13.6 11.0928 13.6 8C13.6 4.90721 11.0928 2.4 8 2.4C4.90721 2.4 2.4 4.90721 2.4 8C2.4 11.0928 4.90721 13.6 8 13.6ZM8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15Z')
        .fill({ color: `#0BAC8F`, rule: 'evenodd' });
      icon
        .path('M7 6C7 6.55228 6.55228 7 6 7C5.44772 7 5 6.55228 5 6C5 5.44772 5.44772 5 6 5C6.55228 5 7 5.44772 7 6Z')
        .fill(`#0BAC8F`);
      icon
        .path('M11 6C11 6.55228 10.5523 7 10 7C9.44772 7 9 6.55228 9 6C9 5.44772 9.44772 5 10 5C10.5523 5 11 5.44772 11 6Z')
        .fill(`#0BAC8F`);
  ...
  SVGDEFS.set(
    ...
    (() => {
      const icon = svg.defs().group();
      icon
        .path('M6.5 9C6.5 9.55228 7.17157 10 8 10C8.82843 10 9.5 9.55228 9.5 9H11C11 10.1046 9.65685 11.5 8 11.5C6.34315 11.5 5 10.1046 5 9H6.5Z')
  ...
  SVGDEFS.set(
    ...
    (() => {
      ...
      icon
        ...
        .fill(`#E66922`);
      icon
        .path('M6.5 11C6.5 10.1716 7.17157 9.5 8 9.5C8.82843 9.5 9.5 10.1716 9.5 11H11C11 9.34315 9.65685 8 8 8C6.34315 8 5 9.34315 5 11H6.5Z')
        .fill({ color: `#E66922`, rule: 'evenodd' });
      // 24x24 invisible rect to prevent icon from
      // shifting with each drag draw update
      icon.path('M0 0h24v24H0z').fill('none');
  ...
  SVGDEFS.set(
    ...
    (() => {
      ...
      icon
        .path('M5 11C5 9.34315 6.34315 8 8 8C9.65685 8 11 9.34315 11 11H5Z')
        .fill(`#E9000E`);
      icon
        .circle(1).cx(6).cy(6)
        .fill(`#E9000E`);
